...
**Dato:** 24. september 2026 (Revidert: Inkl. uteplass for kveldssola m/underbygd kjeller, forlenget drensledning & NV-vanninntak)  
...
4. **Uteplass for kveldssola med underbygd kjeller (NV-krok):** I vinkelen mellom tverrfløyen og inngangsplattingen etableres en uteplass for kveldssola (ca. **2,0 m mot vest × 2,5 m mot nord = 5,0 m²** fotavtrykk) med fullt underbygd kjeller.
   - Dette tiltaket erstatter og formaliserer dagens eksisterende inngangsparti (vedlikehold).
   - Kjeller underbygges ned til kote **C+24,4** med komprimert pukksåle, støpt bunnplate, armerte betongvegger mot terreng (ca. 4,5 lm) og et vanntett, støpt betongdekke (gulv for uteplass over på kote ~C+26,8).
   - Den nye drensledningen og knotteplast/XPS føres rundt ytterveggene på dette nye kjellerrommet.
5. **Vannledning og teknisk inntak i underbygd kjeller (indre NV-hjørne):** Eksisterende stikkledning fra Trollheggveien går inn langs 13,3 m-målelinjen med stoppekran ved tallet 13,3. Ny **32 mm PE-vannledning** kobles på denne stoppekranen og føres nordover til det **indre nordvest-hjørnet**, og tas inn i den nye underbygde kjelleren via vanntett Doyma-hylsegjennomføring.
6. **Oppgradering og justering av innkjøring fra Myrteveien (~200 m²):** Vestgrensen følger målelinjen på 27,7 m, og innkjøringen vider seg ut østover mot Myrteveien frem til eksisterende lyktestolpe ca. midt på tomtegrensen mot nord. Det etableres forsterket bærelag (fiberduk N3 + 0–63 mm pukk) for tung anleggstrafikk (betong- og kranbiler).
...
* **Prosjektert kjellerdør / platå i kjellernedgang & underbygd kjeller:** Kote **C+24,4** (ca. -2,40 m under topp grunnmur)
* **Underkant ny såle for underbygget kjeller & inngangsplatting:** ca. **-2,50 m til -2,60 m** (inkl. pukkpute/isolasjon)
* **Ny bunn drensgrøft rundt tverrfløy, underbygd kjeller og nordvegg:** ca. **-2,65 m til -2,75 m** (Kote ~C+24,1)
...
```mermaid
flowchart TD
    A["1. Rigg & Fjerning av masser"] --> B["2. Utgraving Drensgrøft Tverrfløy & Nordvegg (dybde 2,7 m)"]
    A --> C["3. Utgraving Underbygd Kjeller (NV-krok) & Platting"]
    B --> D["4. Re-drenering & XPS 100-150mm"]
    C --> E["5. Såle & Betongvegger Underbygd Kjeller (kote C+24,4)"]
    E --> F["6. Vanntett Støpt Dekke (Uteplass kveldssol C+26,8)"]
    E --> G["7. Støp av Kjellertrapp m/sluk & smelterør"]
    E --> H["8. Doyma-hylse & Ny Vannledning fra Stoppekran (13,3m)"]
    D --> I["9. Drenering & XPS rundt Underbygd Kjeller"]
    I --> J["10. Tilkobling mot rør fra kjeller (#96) & Overvannskum/LOD"]
    H --> K["11. Bærelag Innkjøring & Terrengplanering"]
```
...
* **Område for ny uteplass for kveldssola m/underbygd kjeller (NV-krok):**
...
* **Underbygd kjeller for uteplass kveldssol (NV-krok, 2,0 m × 2,5 m):**
  ...
  * Forskaling, armering og støping av vanntett betongdekke (tak over underbygd kjeller / gulv for uteplass for kveldssola på kote ~C+26,8, ca. 5,0 m²).
...
### Post 5: Ny Vannledning fra Stoppekran (Trollheggveien) til Underbygd Kjeller (NV-krok)
...
| **2.3** | Utgraving for uteplass kveldssol m/underbygd kjeller i NV-krok (2,0x2,5m, dybde 2,7m) | m³ | ca. 15 | | |
...
| **3.4** | Forskaling og støping av vanntett betongdekke (uteplass kveldssol 5 m² + inngangsplatting 9 m²) | m² | ca. 14 | | |
...
| **5.1** | Grøft og legging av ny 32mm vannledning fra stoppekran (13,3m) til innføring i underbygd kjeller | lm | ca. 15 | | |
